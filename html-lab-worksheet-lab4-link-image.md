...
<body>
    ...
    <section>
        <h1>Gallery</h1>
        <figure>
            <a href="images/products/นํ้าส้ม.jpg">
                <img src="images/products/นํ้าส้ม.jpg" alt="product1" width="200"> 
            </a>
            <figcaption>
                <p>
                    <strong>เมนูนํ้า:</strong>
                    นํ้าส้ม
                </p>
                <p>
                    <strong>ราคา:</strong>
        ...
        <hr>
        <figure>
            <a href="images/products/นํ้ามะพร้าว.jpg">
                <img src="images/products/นํ้ามะพร้าว.jpg" alt="product2" width="200"> 
            </a>
            <figcaption>
                <p>
                    <strong>เมนูนํ้า:</strong>
        ...
        <hr>
        <figure>
            <a href="images/products/นํ้าอะโวคาโด้.jpg">
                <img src="images/products/นํ้าอะโวคาโด้.jpg" alt="product3" width="200"> 
            </a>
            <figcaption>
                <p>
                    <strong>เมนูนํ้า:</strong>
...
![Screenshot 2025-03-07 145128](https://github.com/user-attachments/assets/d212db02-21e9-4935-82a5-05513344c2a1)
![Screenshot 2025-03-07 145209](https://github.com/user-attachments/assets/266bb7cf-67cd-414c-b214-e975f1d13261)
